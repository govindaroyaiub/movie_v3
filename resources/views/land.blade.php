    ...
    <div class="container ">
        <div class="row">
            <div class="col-md-6 mx-auto">
                <h1 class="text-center">Planet Nine Film Platform</h1>
                <h3 class="text-center text-white">Eenvoudig filmreleases publiceren en beheren. Het meest gebruikte
                    platform voor filmpromotie in Nederland en Belgie</h3>
            </div>
        </div>
    </div>
</section>
    ...
    <div class="container">
        ...
        <div class="tab-content pt-3">
            ...
            <div id="credit" class="container tab-pane fade">
                <p>
                    Heeft het recht om te vragen om inzage in en correctie of verwijdering van uw gegevens. Zie hiervoor
                    onze contactpagina. Om misbruik te voorkomen kunnen wij u vragen om u adequaat te identificeren.
                    Wanneer het gaat om inzage in persoonsgegevens gekoppeld aan een cookie, dient u een kopie van het
                    cookie in kwestie mee te sturen.
                </p>
            </div>
            <div id="contact" class="container tab-pane fade">
                <p>
                    Neem contact op met <a href="mailto:info@planetnine.com">info@planetnine.com</a> voor informatie
                    over prijzen en functionaliteiten.
                </p>
            </div>
        </div>
    </div>
