    ...
    <div class="container">
        <div class="row">
            <div class="col-md-6 mx-auto">
                ...
                <h3 class="text-center text-white">Manage and promote movie releases. The most used platform for movie
                    promotion in The Netherlands and Belgium
                </h3>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        ...
        <div class="tab-content pt-3">
            ...
            <div id="contact" class="container tab-pane fade">
                <p>
                    Contact <a href="mailto:info@planetnine.com">info@planetnine.com</a> for pricing and
                    functionalities.
                </p>
            </div>
        </div>
