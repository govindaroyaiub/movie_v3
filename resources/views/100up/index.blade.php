...
<head>
    ...
    <style>
        @import url('https://fonts.googleapis.com/css2?family=Anton&family=Kanit:wght@400;500&display=swap');
                ...
                <div class="col-md-6">
                    <div class="synopsis">
                        <div class="synopsis-meta mt-2">
                            ...
                            @if($movie_details->producer != NULL)
                            <p><span>Producent:</span> {{ $movie_details->producer }}</p>
                            @endif
                            @if($movie_details->actors != NULL)
