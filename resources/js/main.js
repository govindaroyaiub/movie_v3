...
} else if ( location.pathname === "/thereasonijump" || location.pathname === "/thereasonijump_en") {
...
} else if ( location.pathname === "/un_beau_matin" || location.pathname === "/un_beau_matin_en") {
    endpoint = `/un_beau_matin/api/shows`;
}
