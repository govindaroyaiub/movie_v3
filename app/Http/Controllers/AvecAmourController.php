...
class AvecAmourController extends Controller
{
    public function nl_landing()
    {   
        $title = new \Imdb\Title(13535920);
        if(isset($title))
        {
            $rating = $title->rating();
        }
        ...
        $app_url = 'https://movie.planetnine.com/avec-amour-et-acharnement';
        ...
        if ($movie_details == NULL) {
            ...
            return view('avecamour.index', compact(
                'movie_details',
                'youtube_url',
                'poster', 'showtime',
                'city',
    ...
    public function en_landing()
    {
        ...
        if ($movie_details == NULL) {
            ...
            return view('avecamour.index-en', compact(
                'movie_details',
                'youtube_url',
                'poster', 'showtime',
                'city',
