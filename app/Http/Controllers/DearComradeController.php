...
class DearComradeController extends Controller
{
    public function nl_landing()
    {   
        $title = new \Imdb\Title(10796286);
        if(isset($title))
        {
            $rating = $title->rating();
        }
        ...
        $app_url = 'https://movie.planetnine.com/dearcomrades';
        ...
        if ($movie_details == NULL) {
            ...
            return view('dearcomrades.index', compact(
                'movie_details',
                'youtube_url',
                'poster', 'showtime',
                'city',
    ...
    public function en_landing()
    {
        ...
        if ($movie_details == NULL) {
            ...
            return view('dearcomrades.index-en', compact(
                'movie_details',
                'youtube_url',
                'poster', 'showtime',
                'city',
