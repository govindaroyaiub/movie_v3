...
class CowController extends Controller
{
    ...
    {   
        ...
        $app_url = 'https://movie.planetnine.com/cow';
    ...
    public function en_landing()
    {
        ...
        if ($movie_details == NULL) {
            ...
            return view('cow.index-en', compact(
                'movie_details',
                'youtube_url',
                'poster', 'showtime',
                'city',
    ...
    public function viewImage(){
        $image_path = public_path('images/cowposter.jpg');
