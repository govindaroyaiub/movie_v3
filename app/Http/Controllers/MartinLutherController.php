...
class MartinLutherController extends Controller
{
    public function nl_landing()
    {   
        $title = new \Imdb\Title(12801356);
        if(isset($title))
        {
            $rating = $title->rating();
        }
        ...
        $app_url = 'https://movie.planetnine.com/martinlutherking';
        ...
        if ($movie_details == NULL) {
            ...
            return view('martinlutherking.index', compact(
                'movie_details',
                'youtube_url',
                'poster', 'showtime',
                'city',
    ...
    public function en_landing()
    {
        ...
        if ($movie_details == NULL) {
            ...
            return view('martinlutherking.index-en', compact(
                'movie_details',
                'youtube_url',
                'poster', 'showtime',
                'city',
