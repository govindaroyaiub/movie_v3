...
class CunninghamBEController extends Controller
{
    ...
    {   
        ...
        if ($movie_details == NULL) {
            ...
            return view('cunningham_BE.index', compact(
                'movie_details',
                'youtube_url',
                'poster', 
                'showtime',
    ...
    public function en_landing()
    {
        ...
        if ($movie_details == NULL) {
            ...
            return view('cunningham_BE.index-en', compact(
                'movie_details',
                'youtube_url',
                'poster', 'showtime',
                'city',
    ...
    {   
        ...
        if ($movie_details == NULL) {
            ...
            Carbon::setLocale('be');
            $date = Carbon::parse($release_date['date'])->locale('be_BE');
            if(strlen($date->day) == 1)
            {
                $d = '0'.$date->day.' '.$date->monthName.' '.$date->year;
                $first_release_date = strtoupper($d);
            ...
            return view('cunningham_BE.index-fr', compact(
                'movie_details',
                'youtube_url',
                'poster', 
                'showtime',
