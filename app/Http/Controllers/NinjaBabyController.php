...
class NinjaBabyController extends Controller
{
    public function nl_landing()
    {   
        $title = new \Imdb\Title(13821562);
        if(isset($title))
        {
            $rating = $title->rating();
        }
        ...
        $app_url = 'https://movie.planetnine.com/ninjababy';
        ...
        if ($movie_details == NULL) {
            ...
            return view('ninjababy.index', compact(
                'movie_details',
                'youtube_url',
                'poster', 'showtime',
                'city',
    ...
    public function en_landing()
    {
        ...
        if ($movie_details == NULL) {
            ...
            return view('ninjababy.index-en', compact(
                'movie_details',
                'youtube_url',
                'poster', 'showtime',
                'city',
