...
class CunninghamController extends Controller
{
    ...
    {   
        ...
        $app_url = 'https://movie.planetnine.com/cunningham';
        ...
        if ($movie_details == NULL) {
            ...
            return view('cunningham.index', compact(
                'movie_details',
                'youtube_url',
                'poster', 'showtime',
                'city',
    ...
    public function en_landing()
    {
        ...
        if ($movie_details == NULL) {
            ...
            return view('cunningham.index-en', compact(
                'movie_details',
                'youtube_url',
                'poster', 'showtime',
                'city',
