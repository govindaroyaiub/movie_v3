...
class UndineController extends Controller
{
    public function nl_landing()
    {   
        $title = new \Imdb\Title(11617052);
        if(isset($title))
        {
            $rating = $title->rating();
        }
        ...
        $app_url = 'https://movie.planetnine.com/Undine';
        ...
        if ($movie_details == NULL) {
            ...
            return view('undine.index', compact(
                'movie_details',
                'youtube_url',
                'poster', 'showtime',
                'city',
    ...
    public function en_landing()
    {
        ...
        if ($movie_details == NULL) {
            ...
            return view('undine.index-en', compact(
                'movie_details',
                'youtube_url',
                'poster', 'showtime',
                'city',
