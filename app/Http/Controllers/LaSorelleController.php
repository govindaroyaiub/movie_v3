...
class LaSorelleController extends Controller
{
    public function nl_landing()
    {   
        $title = new \Imdb\Title(12789110);
        if(isset($title))
        {
            $rating = $title->rating();
        }
        ...
        $app_url = 'https://movie.planetnine.com/le_sorelle_macaluso';
        ...
        if ($movie_details == NULL) {
            ...
            return view('le_sorelle.index', compact(
                'movie_details',
                'youtube_url',
                'poster', 'showtime',
                'city',
    ...
    public function en_landing()
    {
        ...
        if ($movie_details == NULL) {
            ...
            return view('le_sorelle.index-en', compact(
                'movie_details',
                'youtube_url',
                'poster', 'showtime',
                'city',
