...
class MMatinController extends Controller
{
    public function nl_landing()
    {   
        $title = new \Imdb\Title(13482828);
        if(isset($title))
        {
            $rating = $title->rating();
        }
        ...
        if ($movie_details == NULL) {
            ...
            return view('matin.index', compact(
                'movie_details',
                'youtube_url',
                'poster', 'showtime',
                'city',
    ...
    public function en_landing()
    {
        ...
        if ($movie_details == NULL) {
            ...
            return view('matin.index-en', compact(
                'movie_details',
                'youtube_url',
                'poster', 'showtime',
                'city',
    ...
    public function viewImage(){
        $image_path = public_path('images/matinposter.png');
