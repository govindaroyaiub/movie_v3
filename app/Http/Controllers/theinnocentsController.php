...
class theinnocentsController extends Controller
{
    public function nl_landing()
    {   
        $title = new \Imdb\Title(4028464);
        if(isset($title))
        {
            $rating = $title->rating();
        }
        ...
        $app_url = 'https://movie.planetnine.com/the-innocents';
        ...
        if ($movie_details == NULL) {
            ...
            return view('the_innocents.index', compact(
                'movie_details',
                'youtube_url',
                'poster', 'showtime',
                'city',
    ...
    public function en_landing()
    {
        ...
        if ($movie_details == NULL) {
            ...
            return view('the_innocents.index-en', compact(
                'movie_details',
                'youtube_url',
                'poster', 'showtime',
                'city',
