...
class hittheroadController extends Controller
{
    public function nl_landing()
    {   
        $title = new \Imdb\Title(14812782);
        if(isset($title))
        {
            $rating = $title->rating();
        }
        ...
        $app_url = 'https://movie.planetnine.com/hit_the_road';
        ...
        if ($movie_details == NULL) {
            ...
            return view('hit_the_road.index', compact(
                'movie_details',
                'youtube_url',
                'poster', 'showtime',
                'city',
    ...
    public function en_landing()
    {
        ...
        if ($movie_details == NULL) {
            ...
            return view('hit_the_road.index-en', compact(
                'movie_details',
                'youtube_url',
                'poster', 'showtime',
                'city',
