...
class alliavaController extends Controller
{
    public function nl_landing()
    {   
       $title = new \Imdb\Title(11559472);
        if(isset($title))
        {
            $rating = $title->rating();
        }
        ...
        $app_url = 'https://movie.planetnine.com/aliandava';
        ...
        if ($movie_details == NULL) {
            ...
            return view('aliandava.index', compact(
                'movie_details',
                'youtube_url',
                'poster', 'showtime',
                'city',
    ...
    public function en_landing()
    {
        ...
        if ($movie_details == NULL) {
            ...
            return view('aliandava.index-en', compact(
                'movie_details',
                'youtube_url',
                'poster', 'showtime',
                'city',
