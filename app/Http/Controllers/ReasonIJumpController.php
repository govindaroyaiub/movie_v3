...
class ReasonIJumpController extends Controller
{
    public function nl_landing()
    {   
        $title = new \Imdb\Title(9098928);
        if(isset($title))
        {
            $rating = $title->rating();
        }
        ...
        $app_url = 'https://movie.planetnine.com/thereasonijump';
        ...
        if ($movie_details == NULL) {
            ...
            return view('thereasonijump.index', compact(
                'movie_details',
                'youtube_url',
                'poster', 'showtime',
                'city',
    ...
    public function en_landing()
    {
        ...
        if ($movie_details == NULL) {
            ...
            return view('thereasonijump.index-en', compact(
                'movie_details',
                'youtube_url',
                'poster', 'showtime',
                'city',
