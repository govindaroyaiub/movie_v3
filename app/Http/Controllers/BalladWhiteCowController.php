...
class BalladWhiteCowController extends Controller
{
    public function nl_landing()
    {   
       $title = new \Imdb\Title(11773484);
        if(isset($title))
        {
            $rating = $title->rating();
        }
        ...
        $app_url = 'https://movie.planetnine.com/balladthewhitecow';
        ...
        if ($movie_details == NULL) {
            ...
            return view('balladthewhitecow.index', compact(
                'movie_details',
                'youtube_url',
                'poster', 'showtime',
                'city',
    ...
    public function en_landing()
    {
        ...
        if ($movie_details == NULL) {
            ...
            return view('balladthewhitecow.index-en', compact(
                'movie_details',
                'youtube_url',
                'poster', 'showtime',
                'city',
