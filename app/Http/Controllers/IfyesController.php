...
class IfyesController extends Controller
{
    public function nl_landing()
    {   
        $title = new \Imdb\Title(23144662);
        if(isset($title))
        {
            $rating = $title->rating();
        }
        ...
        $app_url = 'https://movie.planetnine.com/alsuwgatmaarlacht';
    ...
    public function viewImage(){
        $image_path = public_path('images/ifyesokay.jpg');
