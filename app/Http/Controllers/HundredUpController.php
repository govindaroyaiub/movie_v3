...
class HundredUpController extends Controller
{
    public function nl_landing()
    {   
        $title = new \Imdb\Title(13154112);
        if(isset($title))
        {
            $rating = $title->rating();
        }
        ...
        $app_url = 'https://movie.planetnine.com/100UP';
        ...
        if ($movie_details == NULL) {
            ...
            return view('100up.index', compact(
                'movie_details',
                'youtube_url',
                'poster', 'showtime',
                'city',
    ...
    public function en_landing()
    {
        ...
        if ($movie_details == NULL) {
            ...
            return view('100up.index-en', compact(
                'movie_details',
                'youtube_url',
                'poster', 'showtime',
                'city',
