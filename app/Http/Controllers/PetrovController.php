...
class PetrovController extends Controller
{
    public function nl_landing()
    {   
        $title = new \Imdb\Title(10380900);
        if(isset($title))
        {
            $rating = $title->rating();
        }
        ...
        $app_url = 'https://movie.planetnine.com/petrovsflu';
        ...
        if ($movie_details == NULL) {
            ...
            return view('petrov.index', compact(
                'movie_details',
                'youtube_url',
                'poster', 'showtime',
                'city',
    ...
    public function en_landing()
    {
        ...
        if ($movie_details == NULL) {
            ...
            return view('petrov.index-en', compact(
                'movie_details',
                'youtube_url',
                'poster', 'showtime',
                'city',
