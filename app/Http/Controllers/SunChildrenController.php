...
class SunChildrenController extends Controller
{
    public function nl_landing()
    {   
       $title = new \Imdb\Title(11767722);
        if(isset($title))
        {
            $rating = $title->rating();
        }
        ...
        $app_url = 'https://movie.planetnine.com/sunchildren';
        ...
        if ($movie_details == NULL) {
            ...
            return view('sunchildren.index', compact(
                'movie_details',
                'youtube_url',
                'poster', 'showtime',
                'city',
    ...
    public function en_landing()
    {
        ...
        if ($movie_details == NULL) {
            ...
            return view('sunchildren.index-en', compact(
                'movie_details',
                'youtube_url',
                'poster', 'showtime',
                'city',
